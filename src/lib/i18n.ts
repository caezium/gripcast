...
export const I18N: Record<string, Dict> = {
  ...
  ja:{search:"検索",ph:"コース・都市・国 または 'lat, lon'…",list:"リスト",map:"地図",nearMe:"近くのコースを探す",myLoc:"現在地",recent:"最近",featured:"注目のサーキット",tracks:"コース",places:"場所",jumpTo:"移動",searchPlaces:"コースや場所を検索…",language:"言語",reading:"コースを読み込み中…",tapBegin:"タップして開始",locating:"位置を取得中…",noCond:"天気を取得できません",noMatch:"該当なし — コース・都市・'lat, lon'",coords:"座標",toSunset:"日没まで",toSunrise:"日の出まで",toPeak:"ベストグリップまで",peakNow:"今がピーク",peakGrip:"ベストグリップ",conditions:"コンディション",dryVsWet:"ドライ vs ウェット",dryLine:"ドライ",wetLine:"ウェット",trackGrip:"グリップ",lapPace:"ラップペース",comfort:"快適さ",temp:"気温",feelsLike:"体感",humidity:"湿度",cloud:"雲量",wind:"風",gusts:"突風",precip:"降水",pressure:"気圧",trends:"推移",timeline:"タイムライン",nowLbl:"現在",scrubNow:"現在",airDensity:"空気密度",jetting:"ジェッティング",trackTemp:"路面温度",bestWindow:"本日のベスト時間帯",dryUntil:"乾燥は",rainUntil:"雨は",rainFrom:"雨は",dryAllDay:"終日ドライ",rainAllDay:"終日ウェット",light:"弱い",moderate:"中程度",heavy:"強い",richen:"濃く",lean:"薄く",baseline:"基準",units:"単位",
